...
import ParentescoFormPublico from '../membros/ParentescoFormPublico';
      ...
      {abaAtiva === 'perfil' && (
        ...
        <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1">
            ...
            <PhoneInput
              className="w-full p-3 bg-slate-50 rounded-xl font-bold text-sm outline-none focus:ring-2 focus:ring-blue-500/10 disabled:opacity-70"
