export default function Header({ busca, setBusca, totalOriginal, totalFiltrado, onNovo, onBaixarTermoLgpd }) {
    return (
        <header className="bg-blue-900 text-white shadow-xl mb-8">
            <div className="max-w-6xl mx-auto p-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <button
                        type="button"
                        onClick={onBaixarTermoLgpd}
                        className="w-full md:w-auto bg-blue-800/80 border border-white/20 text-white px-6 py-3 rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-lg active:scale-95 whitespace-nowrap"
                    >
                        Termo LGPD (imprimir)
                    </button>
                    <button
